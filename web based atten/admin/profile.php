...
// Get admin data
$adminQuery = "SELECT * FROM users WHERE id = ? AND role = 'admin'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_profile'])) {
  ...
  if ($stmt) {
      mysqli_stmt_bind_param($stmt, "sssi", $name, $email, $phone, $admin_id);
                      ...
                      <div class="card shadow-sm">
                          ...
                          <div class="card-body text-center">
                              <div class="mb-3">
                                  ...
                                  <h4><?php echo htmlspecialchars($admin['name'] ?? 'Administrator'); ?></h4>
                                  <p class="text-muted mb-0">System Administrator</p>
                              </div>
                              <div class="border-top pt-3">
                                  <div class="row mb-2">
                                      <div class="col-6 text-start text-muted">Email:</div>
                                      <div class="col-6 text-end"><?php echo htmlspecialchars($admin['email'] ?? 'N/A'); ?></div>
                                  </div>
                                  <div class="row mb-2">
                                      <div class="col-6 text-start text-muted">Phone:</div>
                                      <div class="col-6 text-end"><?php echo htmlspecialchars($admin['phone'] ?? 'N/A'); ?></div>
                                  </div>
                                  <div class="row mb-2">
                                      <div class="col-6 text-start text-muted">Joined:</div>
                                      <div class="col-6 text-end"><?php echo isset($admin['created_at']) ? date('d M Y', strtotime($admin['created_at'])) : 'N/A'; ?></div>
                                  </div>
                              </div>
                          </div>
                      </div>
